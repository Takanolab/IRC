...
public class CsvUtilforAnimal {
	...
	File file;
	private String mode;
	private String path = Environment.getExternalStorageDirectory().getPath() + "/3DModelData/animal.txt";

	
	public CsvUtilforAnimal(String code){
		mode = code;
		checkFile();
		try{
